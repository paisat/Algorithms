 ...
 * I'm sure somewhere can be simplified so it'd be nice if anyone can let me know. The pattern was that:
 ...
 In this second step, permutations of 2 numbers has only 2 possibilities, meaning each of the three permutations listed above a has two possibilities, giving a total of 6.
...
public class PermutaionSequence {
    ...
    public static void main(String[] args) {
        ...
        PermutaionSequence obj = new PermutaionSequence();
